...
public class BookingServiceImpl implements BookingService {
     ...
     * @throws ValidationException  если дата начала позже даты окончания.
     */
    @Override
    @Transactional
    ...
    public List<BookingResponseDto> getBookingByOwner(Long ownerId, String value) {
        ...
        List<Booking> bookings = BookingsFilterContext.filterBookings(ownerId, state, bookingRepository, true);
    ...
    public List<BookingResponseDto> getAllBookingUserById(Long userId, String value) {
        ...
        List<Booking> bookings = BookingsFilterContext.filterBookings(userId, state, bookingRepository, false);
