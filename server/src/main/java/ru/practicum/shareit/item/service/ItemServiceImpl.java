...
public class ItemServiceImpl implements ItemService {
     ...
     */
    @Override
    public ItemResponseDto create(Long ownerId, ItemDto itemDto) {
        ...
        if (requestId != null) {
            ItemRequest itemRequest = itemRequestService.requestExists(requestId);
    ...
    @Override
    @Transactional
    public ItemResponseDto update(Long ownerId, Long itemId, ItemUpdateRequestDto itemUpdate) {
        Item item = itemExists(itemId);
        if (!Objects.equals(item.getOwner().getId(), ownerId)) {
            throw new InvalidOwnerException(ownerId, itemId);
        }
